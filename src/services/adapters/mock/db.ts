...
const seedDb: MockDb = {
  ...
  employees: [
    ...
    { id: "e-3", userId: "u-emp-3", status: "active", hourlyRate: 390, joinedAt: dayjs().subtract(8, "month").toISOString() },
    { id: "e-4", userId: "u-emp-4", status: "inactive", hourlyRate: 460, joinedAt: dayjs().subtract(4, "month").toISOString() },
    { id: "e-5", userId: "u-emp-5", status: "active", hourlyRate: 500, joinedAt: dayjs().subtract(2, "month").toISOString() },
  ],
  attendance: [
    {
      id: "a-1",
    ...
    },
    {
      id: "a-3",
      employeeId: "e-1",
      clockInAt: dayjs().subtract(2, "day").hour(9).minute(0).toISOString(),
      clockOutAt: dayjs().subtract(2, "day").hour(17).minute(50).toISOString(),
      breakMinutes: 40,
      breakStartAt: null,
    ...
    },
    {
      id: "a-4",
      employeeId: "e-2",
      clockInAt: dayjs().subtract(2, "day").hour(9).minute(35).toISOString(),
      clockOutAt: dayjs().subtract(2, "day").hour(18).minute(20).toISOString(),
      breakMinutes: 35,
      breakStartAt: null,
      approvalStatus: "approved",
      notes: "Client support and QA.",
    },
    {
      id: "a-5",
      employeeId: "e-3",
      clockInAt: dayjs().subtract(2, "day").hour(8).minute(55).toISOString(),
      clockOutAt: dayjs().subtract(2, "day").hour(18).minute(45).toISOString(),
      breakMinutes: 50,
      breakStartAt: null,
      approvalStatus: "approved",
      notes: "Database migration prep.",
    },
    {
      id: "a-6",
      employeeId: "e-5",
      clockInAt: dayjs().subtract(3, "day").hour(10).minute(10).toISOString(),
      clockOutAt: dayjs().subtract(3, "day").hour(19).minute(30).toISOString(),
      breakMinutes: 30,
      breakStartAt: null,
      approvalStatus: "pending",
      notes: "Onboarding + documentation.",
    },
    {
      id: "a-7",
      employeeId: "e-3",
      clockInAt: dayjs().subtract(4, "day").hour(9).minute(20).toISOString(),
      clockOutAt: dayjs().subtract(4, "day").hour(17).minute(40).toISOString(),
      breakMinutes: 45,
      breakStartAt: null,
      approvalStatus: "rejected",
      notes: "Missing end-of-day task notes.",
    },
    {
      id: "a-8",
      employeeId: "e-1",
      clockInAt: dayjs().subtract(5, "day").hour(9).minute(10).toISOString(),
      clockOutAt: dayjs().subtract(5, "day").hour(18).minute(25).toISOString(),
      breakMinutes: 35,
      breakStartAt: null,
      approvalStatus: "approved",
      notes: "Release-day support.",
    },
    {
      id: "a-9",
      employeeId: "e-2",
      clockInAt: dayjs().subtract(6, "day").hour(8).minute(50).toISOString(),
      clockOutAt: dayjs().subtract(6, "day").hour(17).minute(45).toISOString(),
      breakMinutes: 40,
      breakStartAt: null,
      approvalStatus: "approved",
      notes: "",
    },
    {
      id: "a-10",
      employeeId: "e-5",
      clockInAt: dayjs().subtract(7, "day").hour(9).minute(25).toISOString(),
      clockOutAt: dayjs().subtract(7, "day").hour(18).minute(35).toISOString(),
      breakMinutes: 35,
      breakStartAt: null,
      approvalStatus: "pending",
      notes: "Architecture meeting and implementation.",
    },
    {
      id: "a-11",
      employeeId: "e-3",
      clockInAt: dayjs().subtract(8, "day").hour(9).minute(5).toISOString(),
      clockOutAt: dayjs().subtract(8, "day").hour(17).minute(30).toISOString(),
      breakMinutes: 30,
      breakStartAt: null,
      approvalStatus: "approved",
      notes: "",
    },
    {
      id: "a-12",
      employeeId: "e-1",
      clockInAt: dayjs().subtract(9, "day").hour(9).minute(40).toISOString(),
      clockOutAt: dayjs().subtract(9, "day").hour(19).minute(0).toISOString(),
      breakMinutes: 45,
      breakStartAt: null,
      approvalStatus: "approved",
      notes: "Overtime for production issue.",
    },
  ],
  leaves: [
    {
    ...
    },
    {
      ...
      employeeId: "e-3",
      type: "Casual",
      fromDate: dayjs().subtract(20, "day").startOf("day").toISOString(),
      toDate: dayjs().subtract(20, "day").startOf("day").toISOString(),
      reason: "Personal work.",
      attachmentName: null,
      attachmentDataUrl: null,
      status: "rejected",
      appliedAt: dayjs().subtract(24, "day").toISOString(),
      updatedAt: dayjs().subtract(23, "day").toISOString(),
    ...
    },
    {
      ...
      employeeId: "e-5",
      type: "Annual",
      fromDate: dayjs().add(10, "day").startOf("day").toISOString(),
      toDate: dayjs().add(12, "day").startOf("day").toISOString(),
      reason: "Family event.",
      attachmentName: null,
      attachmentDataUrl: null,
      status: "pending",
      appliedAt: dayjs().subtract(2, "day").toISOString(),
